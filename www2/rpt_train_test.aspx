<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_train_test.aspx.cs" Inherits="whms_wheel" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            BackColor="White" ShowParameterPrompts="False">
            <ServerReport ReportPath="/报表项目1/Report1" 
                ReportServerUrl="http://tycho-server/reportserver" />
        </rsweb:ReportViewer>
    </div>
