<%@ Page Language="C#" AutoEventWireup="true" CodeFile="checkLjcha_bz.aspx.cs" Inherits="Verify" Theme="theme" %>
...
<ajaxToolkit:ToolkitScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:tychoConnectionString %>" ProviderName="<%$ ConnectionStrings:tychoConnectionString.ProviderName %>" SelectCommand="exec dbo.GetWheelDataAll @testDateTime">
            <SelectParameters>
    ...
    <ContentTemplate>
        <div class="content">
            ...
            <div class="title"><span class="title">
                <asp:Label ID="lb_title" runat="server" Text="整车差复核"></asp:Label></span>
            </div>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" DataSourceID="SqlDataSource1" OnPreRender="GridView1_PreRender" DataKeyNames="axleNo,wheelNo,整车差">
                    <Columns>
                        ...
                        <asp:BoundField DataField="整车差" HeaderText="整车差" Visible="False" />
        ...
        <div class="content">
            ...
            <table width="50%">
                <tr>
                    <td class="auto-style11"><asp:Label ID="lb_ljcha_zhou" runat="server"  Text="整车差:"></asp:Label></td>
                    <td ><asp:TextBox ID="txt_ljcha_bz"  runat="server"  Width="100%"></asp:TextBox></td>
                </tr>
                <tr>
