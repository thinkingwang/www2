<%@ Page Language="C#" AutoEventWireup="true" CodeFile="checkLjcha_zhou.aspx.cs" Inherits="Verify" Theme="theme" %>
...
<ajaxToolkit:ToolkitScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:tychoConnectionString %>" ProviderName="<%$ ConnectionStrings:tychoConnectionString.ProviderName %>" SelectCommand="exec dbo.GetWheelDataByCarNoAndAxlePos @testDateTime,@carNo,@axlePos">
            <SelectParameters>
                <asp:QueryStringParameter Name="testDateTime" QueryStringField="testDateTime" />
                <asp:QueryStringParameter DefaultValue="" Name="carNo" QueryStringField="carNo" />
                <asp:QueryStringParameter Name="axlePos" QueryStringField="axlePos" />
            </SelectParameters>
        </asp:SqlDataSource>
    ...
    <ContentTemplate>
        <div class="content">
            ...
            <div class="title"><span class="title">
                <asp:Label ID="lb_title" runat="server" Text="同轴轮径差复核"></asp:Label></span>
            </div>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" DataSourceID="SqlDataSource1" OnPreRender="GridView1_PreRender" DataKeyNames="axleNo,wheelNo,同轴轮径差">
                    <Columns>
                        ...
                        <asp:BoundField DataField="同轴轮径差" HeaderText="同轴轮径差" Visible="False" />
        ...
        <div class="content">
            ...
            <table width="50%">
                <tr>
                    <td class="auto-style11"><asp:Label ID="lb_ljcha_zhou" runat="server"  Text="同轴轮径差:"></asp:Label></td>
                    <td ><asp:TextBox ID="txt_ljcha_che"  runat="server"  Width="100%"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="auto-style11"><asp:Label ID="lb_advice" runat="server"    Text="处理意见:"></asp:Label></td>
                ...
                <tr>
                    <td class="auto-style11"><asp:Label ID="lb_desc" runat="server"  Text="处理结论:"></asp:Label></td>
                    <td ><asp:TextBox ID="txt_desc"  TextMode="MultiLine"  Height="80px" runat="server" Width="100%" ></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="auto-style11"><asp:Label ID="lb_recheckPerson" runat="server" Text="复核人:"></asp:Label></td>
                ...
                <tr>
                    <td class="auto-style11"><asp:Label ID="lb_recheckOperator" runat="server" Text="处理人:"></asp:Label></td>
