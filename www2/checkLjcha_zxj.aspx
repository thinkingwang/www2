<%@ Page Language="C#" AutoEventWireup="true" CodeFile="checkLjcha_zxj.aspx.cs" Inherits="Verify" Theme="theme" %>
...
<ajaxToolkit:ToolkitScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:tychoConnectionString %>" ProviderName="<%$ ConnectionStrings:tychoConnectionString.ProviderName %>" SelectCommand="exec dbo.GetWheelDataByCarNoAndZxj @testDateTime,@carNo,@zxj">
            <SelectParameters>
                ...
                <asp:QueryStringParameter Name="zxj" QueryStringField="zxj" />
            </SelectParameters>
        </asp:SqlDataSource>
    ...
    <ContentTemplate>
        <div class="content">
            ...
            <div class="title"><span class="title">
                <asp:Label ID="lb_title" runat="server" Text="同转向架轮径差复核"></asp:Label></span>
            </div>
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" DataSourceID="SqlDataSource1" OnPreRender="GridView1_PreRender" DataKeyNames="axleNo,wheelNo,同转向架轮径差">
                    <Columns>
                        ...
                        <asp:BoundField DataField="同转向架轮径差" HeaderText="同转向架轮径差" Visible="False" />
        ...
        <div class="content">
            ...
            <table width="50%">
                <tr>
                    <td class="auto-style11"><asp:Label ID="lb_ljcha_zhou" runat="server"  Text="同转向架轮径差:"></asp:Label></td>
