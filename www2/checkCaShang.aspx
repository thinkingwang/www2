<%@ Page Language="C#" AutoEventWireup="true" CodeFile="checkCaShang.aspx.cs" Inherits="Verify" Theme="theme" %>
...
<ajaxToolkit:ToolkitScriptManager ID="ScriptManager1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:tychoConnectionString %>" ProviderName="<%$ ConnectionStrings:tychoConnectionString.ProviderName %>" SelectCommand="exec [dbo].[GetWheelDataCaShangByCarNoAndWheelPos] @testDateTime,@carNo,@wheelPos">
    ...
    <ContentTemplate>
        <div class="content">
            ...
            <div class="title"><span class="title">
                <asp:Label ID="lb_title" runat="server" Text="擦伤车轮复核情况"></asp:Label></span>
            </div>
