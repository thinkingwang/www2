<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rpt_train_detail.aspx.cs" Inherits="whms_wheel" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            WaitMessageFont-Size="14pt" Width="988px" Height="748px">
            <LocalReport ReportPath="rpt_train_detail.rdlc">
                <DataSources>
